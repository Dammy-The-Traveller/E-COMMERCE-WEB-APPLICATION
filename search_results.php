...
<div class="text-white border p-4 text-center" style="background-color:#002f4c;">  
        <p class="display-6">search results for <ins style="font-style: italic;"><b><q><?=$_GET['search_key']?></q></b></ins></p> 
</div>
...
<?php
   ...
   if ($log_status) {
    $sql = "SELECT * FROM ad_table  WHERE user_id='$logged_user_id' and status='active' and  name LIKE ?";
  } else {
