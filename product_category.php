...
<body>
  ...
  <br>
  <div class=" text-white border p-4  text-center" style="margin-top: -2rem; background-color:#002f4c;">
    <p class="display-6">Product Under Category <ins style="font-style: italic;"><b><q><?=$_GET['category']?></q></b></ins></p>
  </div>
