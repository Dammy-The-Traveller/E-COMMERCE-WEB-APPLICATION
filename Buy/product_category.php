...
<br><div class=" text-white border p-4  text-center" style="margin-top: -2rem; background-color:#002f4c;">  
        <p class="display-6"><?php 
        $connection = mysqli_connect('localhost','root','','id22297382_selldot',3306);
        $category = '%'.$_GET['category'].'%';
        if ('category'>0) {
          echo 'Products Under Category ';
        }else{
          echo 'Product Under Category ';
        }
        ?> <ins style="font-style: italic;"><b><q><?=$_GET['category']?></q></b></ins></p> 
</div>
