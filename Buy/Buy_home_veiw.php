...
<?php require 'Buy_home_Nav.php' ?>

<div class="card-1" >
       <div class="card-img-overlay">
       <h2 id="h2" class="display-1 pt-3">Buy With Us!</h2>
        <p class="lead" id="h4" >Welcome to SellDot, where buying meet seamlessly! Dive into our platform to discover a vibrant marketplace where you can effortlessly buy and sell a wide array of products. Whether you're on the hunt for unique treasures or looking to turn your items into cash. </p>
        
        <?php 
                      if ($log_status) {
                        echo '
                        <p class="mb-0 border-top w-75 mx-auto pt-5 " id="btn-p">
                        <a href="user/user_profile.php" class="btn btn-lg btn-outline-light w-25" style=" margin-top: 350px;margin-left: -4rem; margin-right: 90px;">  <i class="fas fa-user-circle"></i> '.$logged_user_first_name.'</a>
                        <a href="../register.php" class="btn btn-lg btn-light w-25" style=" margin-top: 350px;margin-left: -4rem; margin-right: 90px;">Become a Seller</a>
                   </p>';
                    }else{
